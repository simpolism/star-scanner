  ...
  return (
    <>
      ...
      <header>
        ...
        <p id="meta-info">
          {data ? 
            `Time generated: ${new Date(data.metadata.generatedAt).toLocaleString()} | ` 
            : 'Loading data...'}
          <a href="https://github.com/simpolism/asi-2027" target="_blank" rel="noreferrer">GitHub</a>
        </p>
      </header>
      ...
      <footer>
        <p>Data generated using Swiss Ephemeris. View <a href="/.netlify/functions/scan" target="_blank" rel="noreferrer">Raw JSON Data</a>.</p>
      </footer>
    </>
  );
}
