...
<li class="event-item">
  ...
  {#if showChart}
    <div class="chart-container" on:click={handleChartClick}>
      <AstroChart {event} chartId={chartId} bind:this={astroChartComponent} />
    </div>
  {/if}
...
<style>
  ...
  :global(.planet-Sun) { color: #e6b800; }
  :global(.planet-Moon) { color: #c0c0c0; }
  :global(.planet-Mercury) { color: #00b3b3; }
  :global(.planet-Venus) { color: #cc00cc; }
  :global(.planet-Mars) { color: #cc0000; }
  :global(.planet-Jupiter) { color: #0000cc; }
  :global(.planet-Saturn) { color: #666666; }
  :global(.planet-Uranus) { color: #00cccc; }
  :global(.planet-Neptune) { color: #0099ff; }
  :global(.planet-Pluto) { color: #cc66cc; }

  /* Sign colors */
  :global(.sign-Aries), :global(.sign-Leo), :global(.sign-Sagittarius) { color: #cc0000; }
  :global(.sign-Taurus), :global(.sign-Virgo), :global(.sign-Capricorn) { color: #006600; }
  :global(.sign-Gemini), :global(.sign-Libra), :global(.sign-Aquarius) { color: #e6b800; }
  :global(.sign-Cancer), :global(.sign-Scorpio), :global(.sign-Pisces) { color: #00b3b3; }

  /* Aspect colors */
  :global(.aspect-conjunction) { color: #ffffff; background-color: #333; padding: 0 3px; }
  :global(.aspect-opposition) { color: #cc0000; }
  :global(.aspect-trine) { color: #006600; }
  :global(.aspect-square) { color: #cc0000; }
  :global(.aspect-sextile) { color: #e6b800; }

  /* Event type colors */
  .type-aspect_end { color: #cc00cc; }
  .type-aspect_begin { color: #00cc00; }
  .type-aspect_peak { color: #6495ED; }
